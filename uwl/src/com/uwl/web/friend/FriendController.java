...
public class FriendController {
	...
	public String getFriendList(@RequestParam("userId") String userId, @ModelAttribute Search search, Model model) throws Exception{
	...
	public String getSearchFriendList(@ModelAttribute Search search, @RequestParam String userId, Model model) throws Exception{
		if (search.getCurrentPage() == 0) {
			search.setCurrentPage(1);
		}
		search.setPageSize(pageSize);
