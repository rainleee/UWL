	...
	public boolean preHandle(	HttpServletRequest request,
		...
		if(   user != null   )  {
			...
			if(		uri.indexOf("addUser") != -1 ||	uri.indexOf("login") != -1 		|| 
				...
				request.getRequestDispatcher("/toolbarMain.jsp").forward(request, response);
			...
			if(		uri.indexOf("addUser") != -1 ||	uri.indexOf("login") != -1 		|| 
					uri.indexOf("checkDuplication") != -1 || uri.indexOf("checkMail") != -1 || 
					uri.indexOf("sendSms") != -1){
